...
**假设**：已经使用**vscode/AI IDE**连接上了**linux**服务器，linux服务器**常见工具**和**conda**配置好了，也能正常**联网**，dockers也配置了且有权限，这一步不再演示。同时，我们假设所有的python库都安装好了，从0复现的时候，需要手动去安装一些库，例如**botorch**，这里不再演示。
